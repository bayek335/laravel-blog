...
<div class="row justify-content-center mt-4">
    <h1 class="text-center ">Posts - Writer " {{ $posts[0]->user->name }} "</h1>
</div>
<div class="row ">
...
<div class="row px-2 mt-3">
    ...
    <div class="col-lg-4 mt-3 ">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <small>
                    <p class="m-0"> <a class="text-decoration-none" href="/categories/{{ $post->category->slug }}">{{ $post->category->category_name }}</a> {{ $post->created_at->diffForHumans() }} </p>
                </small>
